...
const SessoesPage = () => {
  ...
  const { data: sessoes, loading, error, fetchData, createItem, updateItem, deleteItem } = useApi(sessaoService);
  ...
  return (
    <div className="container py-4">
      ...
      >
        <p>
          Tem certeza que deseja excluir a sessão do filme <strong>{sessaoToDelete?.filme.titulo}</strong> na sala <strong>{sessaoToDelete?.sala.numero}</strong>?
        </p>
      </Modal>
